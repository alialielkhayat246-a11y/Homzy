...
const Map<String, Map<String, String>> _strings = {
  ...
  'stage_contact': {'en': 'Contact', 'ar': 'تواصل'},
  'stage_contacted': {'en': 'Contacted', 'ar': 'اتكلمت معاه'},
  'stage_qualified': {'en': 'Qualified', 'ar': 'مؤهل'},
  'stage_matching': {'en': 'Matching', 'ar': 'مطابقة'},
  'stage_viewing': {'en': 'Viewing', 'ar': 'معاينة'},
  'stage_offer_sent': {'en': 'Offer sent', 'ar': 'تم إرسال العرض'},
  'stage_negotiate': {'en': 'Negotiation', 'ar': 'تفاوض'},
  'stage_reservation': {'en': 'Reservation', 'ar': 'حجز'},
